...
if(global.perkS1player1 == 1){
    ...
    with(obj_player1_perk2){
        ...
        if(sprite_index!=spr_perk8){
            with(obj_player1_perk1)sprite_index = spr_perk8;
        }
    }
    ...
    with(obj_player1_perk1){
        instance_activate_object(obj_player1_perk2);
        if(sprite_index!=spr_perk8){
            with(obj_player1_perk2)sprite_index = spr_perk8;
        }
    }
...
if(global.perkS1player2 == 1){
    with(obj_player2_perk2){
        ...
        if(sprite_index!=spr_perk8){
            with(obj_player2_perk1)sprite_index = spr_perk8;
        }
    }
    ...
    with(obj_player2_perk1){
        ...
        if(sprite_index!=spr_perk8){
            with(obj_player2_perk2)sprite_index = spr_perk8;
        }
    }

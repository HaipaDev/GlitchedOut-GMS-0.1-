...
if(timer2==0){
    if(dead==false){
        ...
        instance_create(x, y, htme_obj_splitP1);
        instance_create(x+15, y, htme_obj_splitP1);
        instance_create(x-15, y, htme_obj_splitP1);
        }
...
/// Collisions
// Player
/*if(place_meeting(x, y, htme_obj_player2)){
    random_teleport();
    ...
    if (moving)htme_obj_player2.hp -= self.dmg;
...
if(perkS1==8 or perkS2==8){
    if(!instance_exists(htme_obj_end_hud)){

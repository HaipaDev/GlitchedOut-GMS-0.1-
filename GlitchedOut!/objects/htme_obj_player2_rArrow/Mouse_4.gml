...
switch(sprite_index) {
    case spr_player2:
        ...
        if (global.skinP1 == 3) {sprite_index = spr_player4;
    ...
    case spr_player3:
        ...
        if (global.skinP1 == 4) {sprite_index = spr_player5;
    ...
    case spr_player4:
        ...
        with(htme_obj_player2choose) sprite_index = spr_player5; htme_globalSet("skinP1",5,buffer_u8);
        if (global.skinP1 == 5) {sprite_index = spr_player6;
    ...
    case spr_player5:
        ...
        if (global.skinP1 == 6) {sprite_index = spr_player7;
    ...
    case spr_player6:
        ...
        if (global.skinP1 == 7) {sprite_index = spr_player1;
    ...
    case spr_player7:
        ...
        if (global.skinP1 == 1) {sprite_index = spr_player2;
    ...
    case spr_player1:
        ...
        if (global.skinP1 == 2) {sprite_index = spr_player3;
